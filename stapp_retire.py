...
def main():
    ...
    if choice == "About":
        ...
        image = Image.open("08da33ad-s.jpg")
        st.image(image)

        #components.html("""""")
        st.markdown("Build by [Nonomura Ryutaro]")
        st.text("Nonomura saikyo")
        st.markdown("野々村竜太郎最強伝説   (https://www.google.com/search?q=%E9%87%8E%E3%80%85%E6%9D%91%E3%81%AE%E6%8B%B3&rlz=1C1FQRR_jaJP950JP950&sxsrf=ALiCzsYHABppE9-1m-Oz2NOezrgfTLCUag:1670289953704&source=lnms&tbm=vid&sa=X&ved=2ahUKEwi74_L66uP7AhWVO3AKHV8vDJ0Q_AUoAnoECAIQBA&biw=1536&bih=754&dpr=1.25#fpstate=ive&vld=cid:e45012d8,vid:bMON5idUjoA)")
